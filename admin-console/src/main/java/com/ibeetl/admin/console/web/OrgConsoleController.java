...
public class OrgConsoleController {
	...
	@Function("org.query")
	public ModelAndView getUsers(String orgId) {
	...
	@Function("org.query")
	@ResponseBody
	public JsonResult<PageQuery<CoreOrg>> list(OrgQuery condition) {
		PageQuery page = condition.getPageQuery();
		orgConsoleService.queryByCondition(page);
	...
	@Function("org.save")
	@ResponseBody
	public JsonResult<String> save(@Validated(ValidateConfig.ADD.class) CoreOrg org, BindingResult result) {
		if (result.hasErrors()) {
			return JsonResult.failMessage(result.toString());

		}
		org.setId(UUIDUtil.uuid());
