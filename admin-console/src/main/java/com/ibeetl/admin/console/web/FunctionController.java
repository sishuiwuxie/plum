...
//		function.setCreateTime(dbFunction.getCreateTime());
	...
	@ResponseBody
	public JsonResult<CoreFunction> getFunction(String id) {
	...
	@ResponseBody
	public JsonResult deleteFunction(String id) {
	...
	@Function("function.query")
	@ResponseBody
	public JsonResult<PageQuery<CoreFunction>> list(FunctionQuery condition) {

		PageQuery page = condition.getPageQuery();
		functionConsoleService.queryByCondition(page);
	...
	private List<String> findChildFunctionIds(String funtionId) {

		FunctionItem funItem = platformService.buildFunction().findChild(funtionId);
		List<String> children = funItem.findAllChildrenId();
