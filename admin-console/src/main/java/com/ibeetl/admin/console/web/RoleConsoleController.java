...
public class RoleConsoleController {
	...
	public ModelAndView users(String roleId) {
	...
	@Function("role.query")
	@ResponseBody
	public JsonResult<PageQuery> list(RoleQuery condition) {
		PageQuery page = condition.getPageQuery();
		roleConsoleService.queryByCondition(page);
	...
	@Function("role.query")
	@ResponseBody
	public JsonResult<CoreRole> queryInfo(String id) {
		CoreRole role = roleConsoleService.queryById(id);
	...
	public JsonResult delete(String ids) {
		...
		List<String> idList = ConvertUtil.str2Strs(ids);
	...
	@Function("role.function.query")
	@ResponseBody
	public JsonResult<List<String>> getFunctionIdByRole(String roleId) {
		List<String> list = functionConsoleService.getFunctionByRole(roleId);
		return JsonResult.success(list);
	}
	...
	@Function("role.function.query")
	@ResponseBody
	public JsonResult<List<RoleDataAccessFunction>> getQueryFunctionByRole(String roleId) {
	...
	@ResponseBody
	public JsonResult updateFunction(String roleId, String ids) {
		List<String> all = ConvertUtil.str2Strs(ids);
		List<String> addIds = new ArrayList<>();
		List<String> delIds = new ArrayList<>();
		List<String> dbs = functionConsoleService.getFunctionByRole(roleId);
	...
	@ResponseBody
	public JsonResult updateFunctionDataAccess(String roleId, String fnId, Integer accessType) {
	...
	@Function("role.function.updateDataAccess")
	public ModelAndView datapage(String roleId) {
		List<RoleDataAccessFunction> list = functionConsoleService.getQueryFunctionByRole(roleId);
