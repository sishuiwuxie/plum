...
public class FileSystemContorller {
	...
	public JsonResult uploadFile(@RequestParam("file") MultipartFile file, String batchFileUUID, String bizType, String bizId) throws IOException {
		...
		OutputStream os = fileItem.openOutputStream();
	...
	@ResponseBody
	public JsonResult deleteFile(String fileId, String batchFileUUID) throws IOException {
	...
	public ModelAndView download(HttpServletResponse response, @PathVariable String fileId, @PathVariable String batchFileUUID) throws IOException {
