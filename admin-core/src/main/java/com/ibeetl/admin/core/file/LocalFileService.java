...
public class LocalFileService implements FileService {
	...
	@Override
	public FileItem createFileItem(String name, String bizType, String bizId,
	                               String userId, String orgId, String fileBatchId, List<FileTag> tags) {
	...
	@Override
	public FileItem getFileItemById(String id) {
		return this.getFileItem(dbHelper.getFileItemById(id));
	}

	@Override
	public List<FileItem> queryByUserId(String userId, List<FileTag> tags) {
	...
	@Override
	public void removeFile(String id, String fileBatchId) {
	...
	@Override
	public FileItem getFileItemById(String id, String fileBatchId) {
		CoreFile file = dbHelper.getFileItemById(id);
		if (!file.getFileBatchId().equals(fileBatchId)) {
			return null;
		}
