...
public class CorePlatformService {
	...
	public void changeOrg(String orgId) {
	...
	public MenuItem getMenuItem(String userId, String orgId) {
		CoreUser user = this.sysUserDao.unique(userId);
		if (this.isSupperAdmin(user)) {
			MenuItem menu = self.buildMenu();
			return menu;
		}
		Set<String> allows = self.getCurrentMenuIds(userId, orgId);
	...
	public List<CoreRoleFunction> getRoleFunction(String userId, String orgId, String fucntionCode) {
	...
	public boolean canAcessFunction(String userId, String orgId, String functionCode) {

		CoreUser user = getCurrentUser();
		if (user.getId().equals(userId) && isSupperAdmin(user)) {
			return true;
		}
	...
	public List<String> getChildrenFunction(String userId, String orgId, String parentFunction) {
	...
	public Set<String> getCurrentMenuIds(String userId, String orgId) {
		List<String> list = sysRoleMenuDao.queryMenuByUser(userId, orgId);
	 ...
	 * @return
	 */
	public boolean canShowMenu(CoreUser user, MenuItem item, Set<String> allows) {
	 ...
	 * @return
	 */
	public List<MenuItem> getChildMenu(String menuId) {
		MenuItem root = buildMenu();
